                                        ...
                                        <TableRow key={scheduleIndex}>
                                            <TableCell>
                                                {editMode ? (
                                                    ...
                                                    <span>
                                                        {schedule.DeliverySchedule.start_date}
                                                    </span>
                                                )}
                                            </TableCell>
                                            <TableCell>
                                                {editMode ? (
                                                    ...
                                                    <span>
                                                        {schedule.DeliverySchedule.end_date}
                                                    </span>
                                                )}
                                            </TableCell>
                                            <TableCell>
                                                ...
                                                {editMode ? (
                                                    <Input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            updatedSchedules[
                                                                scheduleIndex
                                                            ].DeliverySchedule.deliveryAmount =
                                                    ...
                                                    <span>
                                                        {schedule.DeliverySchedule.deliveryAmount}
                                                    </span>
                                                )}
                                            </TableCell>
                                            <TableCell>
                                                {editMode ? (
                                                    <div className='grid gap-2'>
                                                        ...
                                                        <span>
                                                            СПГЗ ID:{' '}
                                                            {schedule.spgzCharacteristics.spgzId}
                                                        </span>
                                                        <span>
                                                            Название СПГЗ:{' '}
                                                    ...
                                                    <div className='grid gap-2'>
                                                        <span>
                                                            {(schedule.purchaseAmount || 0).toFixed(
                                                                2
                                                            )}
                                                        </span>
                                                        <span>
